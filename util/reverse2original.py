...
def reverse2wholeimage2(b_align_crop_tenor_list, swaped_imgs, mats, crop_size, oriimg, logoclass, save_path = '', \
    ...
    if use_mask:
        ...
        for swaped_img, mat, source_img in zip(swaped_imgs, mats,b_align_crop_tenor_list):
            ...
            source_img_512_li.append(source_img_512.squeeze())
            
#             print('====================================================')
#             print('len(swaped_img_li)=',len(swaped_img_li))
#             print('len(mat_rev_li)=',len(mat_rev_li))
#             #print('len(source_img_512_li)=',len(source_img_512_li))
            
#             print('swaped_img_li[0].shape=',swaped_img_li[0].shape)
#             print('mat_rev_li[0].shape=',mat_rev_li[0].shape)
#             print('source_img_512_li[0].shape=',source_img_512_li[0].shape)
#             print('====================================================')
    
        source_img_512_li = torch.stack(source_img_512_li, dim = 1)
        source_img_512_li = source_img_512_li.transpose(0,1).contiguous()
    
        out_li = pasring_model(source_img_512_li)[0]
...
#         for dataset in tqdm(source_img_512_li):
        ...
        #out_t = torch.cat(out_t, dim = 0) # 여기 문제 부분
