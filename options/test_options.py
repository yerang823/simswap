...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--pics', type=str, help='Image folder')
        self.parser.add_argument('--vids', type=str, help='Video folder')
        self.parser.add_argument('--output_folder', type=str, help='Output folder')
        self.parser.add_argument('--num_batch_size', type=int, default=1, help='batch size')
