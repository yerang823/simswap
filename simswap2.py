...
from insightface_func.face_detect_crop_multi import Face_detect_crop
from util.videoswap_inggggg import video_swap
    ...
    for v in vids:
        ...
        for p in pics:
            ...
            with torch.no_grad():
                ...
                #video_swap(opt.video_path, latend_id, model, app, opt.output_path, temp_results_dir=opt.temp_path, use_mask=opt.use_mask, n_batch_size=num_batch_size)
                video_swap(opt.video_path, latend_id, model, app, opt.output_path, temp_results_dir='./tmp2/', use_mask=opt.use_mask, n_batch_size=num_batch_size)
